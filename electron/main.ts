...
app.whenReady().then(() => {
  const scriptSrc = isDev ? "'self' 'unsafe-eval' https://cdn.tailwindcss.com https://accounts.google.com/gsi/client https://esm.sh" : "'self' https://cdn.tailwindcss.com https://accounts.google.com/gsi/client";
  const csp = `default-src 'self'; script-src ${scriptSrc}; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://esm.sh *.google.com; img-src 'self' data: blob:; frame-src https://accounts.google.com/gsi/`;
