    ...
    if (hasConfigError) {
        return (
            <PageStateCard
                ...
                tone="error"
                action={<NavLink to="/settings" className="inline-flex px-4 py-2 rounded-xl border border-red-300 text-red-700 text-sm font-bold hover:bg-red-50 transition">الانتقال إلى الإعدادات</NavLink>}
            />
        );
    }
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {!hasFinancialData && (
                <PageStateCard
                    ...
                    action={<NavLink to={FINANCIAL_ROUTES.invoices} className="inline-flex px-4 py-2 rounded-xl bg-primary text-white text-sm font-bold hover:bg-primary/90 transition">إنشاء أول فاتورة</NavLink>}
                />
            )}
