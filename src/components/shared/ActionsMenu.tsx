...
const ActionsMenu: React.FC<ActionsMenuProps> = ({ items }) => {
  ...
  return (
    <div className="relative inline-block text-start" ref={wrapperRef}>
      <div>
        <button
          type="button"
      ...
      {isOpen && (
        <div className="origin-top-left absolute start-0 mt-2 w-48 rounded-md shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 z-10">
