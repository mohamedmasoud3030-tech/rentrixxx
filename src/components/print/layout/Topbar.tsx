      ...
      <div className="flex h-full items-center justify-between flex-row-reverse px-4 md:px-6 gap-3">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="hidden lg:flex items-center min-w-[260px] relative">
            ...
            <input readOnly placeholder="بحث سريع..." className="bg-rx-surface-high rounded-xl border border-rx pe-9 text-sm" />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="w-8 h-8 rounded-xl flex items-center justify-center text-primary-fg font-bold text-sm rx-gradient-btn">{username.charAt(0).toUpperCase()}</div>
