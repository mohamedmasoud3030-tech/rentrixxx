-- 2026-04-11: Atomic financial core hardening

-- 1) Idempotency support for receipt posting
...
begin
  ...
  if v_request_id is null then
    raise exception 'request_id is required for idempotency';
  end if;
...
-- 4) Soft delete column + hard delete guard (Arabic message)
