  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(24rem,0.9fr)]">
        ...
        <Card><CardHeader><CardTitle>اتفاقيات الإدارة</CardTitle><CardDescription>هذه الاتفاقية تحدد طريقة العلاقة المالية بين المكتب والمالك، ولا يتم حساب كشف حساب المالك النهائي في هذه المرحلة.</CardDescription></CardHeader><CardContent className="space-y-3"><p className="text-sm text-muted-foreground">سيتم ربط قائمة الاتفاقيات الفعلية بعد تفعيل جداول اتفاقيات الإدارة في بيئة التطبيق.</p><Button variant="secondary" disabled>إضافة/تعديل الاتفاقيات (المرحلة القادمة داخل نفس الواجهة)</Button></CardContent></Card>
