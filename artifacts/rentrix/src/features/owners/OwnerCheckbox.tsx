...
// The project currently has no shared Checkbox component under components/ui,
// so owner forms use this small native fallback until a shared primitive exists.
