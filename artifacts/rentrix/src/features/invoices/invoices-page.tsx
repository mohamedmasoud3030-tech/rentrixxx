  ...
  return (
    <div className="space-y-6" dir="rtl">
      ...
      <Card className="overflow-hidden">
        ...
        {invoicesQuery.isError && filteredInvoices.length === 0 ? <div className="p-4 text-destructive">{getErrorMessage(invoicesQuery.error, 'تعذر تحميل الفواتير')}</div> : null}
        {invoicesQuery.isError && filteredInvoices.length > 0 ? <div className="p-4 text-sm text-destructive">{getErrorMessage(invoicesQuery.error, 'تعذر تحديث الفواتير. يتم عرض آخر بيانات متاحة.')}</div> : null}
