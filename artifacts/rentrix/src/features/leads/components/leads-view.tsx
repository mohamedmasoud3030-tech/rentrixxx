...
export function LeadsView(props: Props) {
  ...
  return (
    <section className="space-y-5">
      ...
      {!isLoading && !error && rows.length === 0 ? <StateCard title="لا توجد نتائج" description="أضف أول عميل محتمل أو غيّر عوامل البحث." /> : null}
