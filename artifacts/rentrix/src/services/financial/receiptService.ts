...
async function loadReceiptRecords(supabase: SupabaseClient, payments: Payment[]): Promise<ReceiptRecord[]> {
...
export async function listReceipts(supabase: SupabaseClient, params: ReceiptListParams = {}): Promise<ReceiptRecord[]> {
  ...
  return loadReceiptRecords(supabase, payments ?? []);
}
