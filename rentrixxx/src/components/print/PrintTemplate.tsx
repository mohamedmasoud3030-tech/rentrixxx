...
export const ReceiptPrint = ({ data, settings }: any) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: '80px', display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
        <div style={{ textAlign: 'center', flex: 1 }}>
          <p style={{ fontWeight: 700 }}>توقيع المستلم</p>
          <div style={{ width: '100%', marginTop: '10px', borderBottom: '1px solid #333', height: '32px' }} />
          <p style={{ marginTop: '6px', fontSize: '12px', color: '#666' }}>الاسم</p>
        </div>

        <div style={{ textAlign: 'center', flex: 1 }}>
          <p style={{ fontWeight: 700 }}>ختم المؤسسة</p>
          <br />
          {stamp ? (
        ...
        <div style={{ textAlign: 'center', flex: 1 }}>
          <p style={{ fontWeight: 700 }}>توقيع المحاسب</p>
          <div style={{ width: '100%', marginTop: '10px', borderBottom: '1px solid #333', height: '32px' }} />
          <p style={{ marginTop: '6px', fontSize: '12px', color: '#666' }}>التاريخ</p>
        </div>
      </div>
    </div>
  );
